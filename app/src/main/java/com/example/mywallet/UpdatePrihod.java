...
public class UpdatePrihod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_prihod);

        et_vrijednost=findViewById(R.id.et_vrijednost2);
        et_biljeska=findViewById(R.id.et_biljeska2);
        spinner=findViewById(R.id.spinner3);
        btn_azuriraj=findViewById(R.id.btn_azuriraj2);
        btn_izbrisi=findViewById(R.id.btn_izbrisi2);
        getAndSetIntentData();
        btn_azuriraj.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DataBaseHelper db = new DataBaseHelper(UpdatePrihod.this);
                ...
                db.updateDataPrihod(id, kategorija, vrijednost, biljeska);
                Intent intent = new Intent(UpdatePrihod.this, MainActivity.class);
